# ------------------------------------------------------------
# Auto generated test file `test_AMMGammaLib_.py`
# ------------------------------------------------------------
# source file   = AMMGammaLib_Test.py
...
# ------------------------------------------------------------
# Test      AMMGammaLib
# File      test_AMMGammaLib_.py
# Segment   gamma_gain fee_payment  [NOTEST]
# ------------------------------------------------------------
def notest_gamma_gain_fee_payment():
# ------------------------------------------------------------
...
# Test      AMMGammaLib
# File      test_AMMGammaLib_.py
# Segment   AMMSim Demo [NOTEST]
# ------------------------------------------------------------
def notest_ammsim_demo():
# ------------------------------------------------------------
